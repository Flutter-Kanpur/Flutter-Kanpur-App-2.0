...
// Event Card Styles
TextStyle textStyle_12SemiBoldWhite() {
  return TextStyle(
    fontFamily: 'ProductSans',
    fontSize: 12.sp,
    fontWeight: FontWeight.w600,
...
TextStyle textStyle_24BoldBlue() {
  return TextStyle(
    fontFamily: 'ProductSans',
    fontSize: 24.sp,
    fontWeight: FontWeight.w700,
...
TextStyle textStyle_13SemiBoldBlue() {
  return TextStyle(
    fontFamily: 'ProductSans',
    fontSize: 13.sp,
    fontWeight: FontWeight.w600,
...
TextStyle textStyle_13RegularGrey() {
  return TextStyle(
    fontFamily: 'ProductSans',
    fontSize: 13.sp,
    fontWeight: FontWeight.w400,
...
TextStyle textStyle_18regularWhite() {
  return TextStyle(
    fontFamily: 'ProductSans',
    fontSize: 18.sp,
    fontWeight: FontWeight.w400,
