...
/// Filter chip row. [onSelect] gets the tapped label, or `null` when the
/// selected chip is tapped again to clear it. "Filters" (index 0) is a
/// no-op - no sheet built yet.
class ProjectFilterChipsRow extends StatelessWidget {
  const ProjectFilterChipsRow({
    super.key,
