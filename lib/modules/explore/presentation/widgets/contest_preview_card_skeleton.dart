...
/// Loading placeholder for [ContestPreviewCard], same block layout as
/// `CommunityProjectPreviewCardSkeleton`.
class ContestPreviewCardSkeleton extends StatelessWidget {
  const ContestPreviewCardSkeleton({super.key});
