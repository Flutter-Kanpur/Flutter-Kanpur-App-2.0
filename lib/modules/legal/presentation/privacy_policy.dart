          ...
          child: Column(
            ...
            children: [
              _buildContentContainer(
                ...
                body: translate(context, "profile_privacy_policy.body_1"),
              ),
              _buildContentContainer(
                showBackground: false,
                body: translate(context, "profile_privacy_policy.body_2"),
              ),
              _buildContentContainer(
                showBackground: false,
                body: translate(context, "profile_privacy_policy.body_3"),
              ),
              _buildContentContainer(
                showBackground: false,
                body: translate(context, "profile_privacy_policy.body_4"),
              ),
              _buildContentContainer(
                showBackground: false,
                body: translate(context, "profile_privacy_policy.body_5"),
              ),
